class Admin::ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :price, :price, :stock, :category_id, :image, :remove_image, :image_cache, :remote_image_url, :address, :longitude, :latitude )
    end
end
